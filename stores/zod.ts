...
import type { SchemaWindShieldLocation, SchemaDuctType, SchemaDuctShape, SchemaBatteryLocation, SchemaCombustionAirSupplySituation, SchemaFlueGasExhaustSituation, SchemaFuelType, SchemaInverterType, MVHRLocation, SchemaPhotovoltaicVentilationStrategy, SchemaWaterPipeworkLocation, SchemaWaterPipeContentsType, SchemaWindowTreatmentType, SchemaWindowTreatmentControl, SchemaShadingObjectType, SchemaVentilationShieldClass, SchemaTerrainClass, SchemaHeatPumpBackupControlType, SchemaHeatPumpSinkType, SchemaHeatPumpSourceType, WwhrsType, CombustionFuelType, SchemaMassDistributionClass, SchemaThermalBridgeJunctionType } from "~/schema/aliases";
...
const massDistributionClasses = ["D", "E", "I", "IE", "M"] as const satisfies SchemaMassDistributionClass[];
...
const waterPipeContentsTypes = ["water", "glycol25", "air"] as const satisfies SchemaWaterPipeContentsType[];
...
export const massDistributionClassZod = zodForTypeOptions(ensureAllUnion<SchemaMassDistributionClass, (typeof massDistributionClasses)>(massDistributionClasses));
