...
<template>
  ...
  <FormKit v-model="model" type="form" :actions="false" :incomplete-message="false" @submit="saveForm"
    ...
    <FormKit id="typeOfHeatEmitter" type="govRadios" label="Type of heat emitter" :options="heatEmitterTypes"
    ...
    <UnderfloorHeatingSection v-if="model?.typeOfHeatEmitter === 'underfloorHeating'"
    ...
    <InstantElectricHeaterSection v-if="model?.typeOfHeatEmitter === 'instantElectricHeater'"
      :model="model as InstantElectricHeaterModelType" />
    <ElectricStorageHeaterSection v-if="model?.typeOfHeatEmitter === 'electricStorageHeater'"
      :model="model as ElectricStorageHeaterModelType" />
    <WarmAirHeaterSection v-if="model?.typeOfHeatEmitter === 'warmAirHeater'"
