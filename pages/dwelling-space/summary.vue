...
const windowSummary: SummarySection = {
	...
	data: windowData.map(x => {
		return {
			...
			"Overhang distance from glass": 'overhangDistance' in x ? x.overhangDistance : undefined,
			"Side fin right depth": 'sideFinRightDepth' in x ? x.sideFinRightDepth : undefined,
			"Side fin right distance from glass": 'sideFinRightDistance' in x ? x.sideFinRightDistance : undefined,
			"Side fin left depth": 'sideFinLeftDepth' in x ? x.sideFinLeftDepth : undefined,
			"Side fin left distance from glass": 'sideFinLeftDistance' in x ? x.sideFinLeftDistance : undefined,
