...
import type {BoilerData, HeatPumpData, HeatBatteryData, HeatNetworkData} from '~/stores/ecaasStore.types';
...
interface HeatGenerationData extends HeatPumpData, BoilerData, HeatBatteryData, HeatNetworkData {};
