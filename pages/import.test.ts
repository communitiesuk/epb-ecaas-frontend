...
describe('import page', () => {
	...
	it('merges the file contents into the store if the file is good', async () => {
		...
		expect(store.dwellingDetails.generalDetails.data.typeOfDwelling).toBe('house');
	});
