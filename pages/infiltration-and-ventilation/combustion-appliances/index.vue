...
interface ApplianceData extends OpenFireplaceData, ClosedFireplaceWithFanData, OpenGasFlueBalancerData, OpenGasKitchenStoveData, OpenGasFireData, ClosedFireData {}
