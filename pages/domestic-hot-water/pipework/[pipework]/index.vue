...
<template>
	...
	<FormKit
		...
		<FormKit
			...
			type="govInputWithSuffix"
			label="Length"
			help="Enter the length of the flow and return pipework between the cylinder and the heat source. Typically 5-20m for a small apartment and 20-50m for a larger house."
			name="length"
