...
<template>
	<div class="govuk-pagination govuk-!-margin-bottom-3" aria-label="Pagination">
		...
		<ul class="govuk-pagination__list" v-if="totalPages >= minPageNumbers && totalPages < minPageNumbersToSplit">
			<li class="govuk-pagination__item" v-for="pageNumber in totalPages"
		...
		<ul class="govuk-pagination__list" v-if="totalPages >= minPageNumbersToSplit">
