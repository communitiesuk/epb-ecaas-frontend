...
<template>
	...
	<FormKit id="selectElectricStorageHeater" type="govPcdbProduct" label="Select product"
		name="selectElectricStorageHeater" validation="required" :help="''" :selected-product-reference="''"
		:selected-product-type="''" :page-url="''" :page-index="1" />
	<FormKit id="numOfStorageHeaters" name="numOfStorageHeaters" type="govInputInt" label="Number of storage heaters"
