...
<template>
	...
	<FormKit
		id="selectFanCoil" type="govPcdbProduct" label="Select product" name="productReference" validation="required"
		:help="''" :selected-product-reference="''" :selected-product-type="''" :page-url="''" :page-index="1" />
	...
	<FormKit
		id="hasVariableFlowRate" type="govBoolean" label="Is there a variable flow rate?" name="hasVariableFlowRate"
		validation="required" />
	<FormKit
	...
	<FormKit
		id="numOfFanCoils" name="numOfFanCoils" type="govInputWithSuffix" label="Number  of fan coils"
		suffix-text="m²" validation="required" />
</template>
