...
<template>
	<FormKit
		id="typeOfHeatPump" type="govRadios" label="Type of heat pump" :options="heatPumpTypes" name="typeOfHeatPump"
		validation="required" @click="emit('update-heat-pump-model', 'typeOfHeatPump')" />
	<FormKit
		v-if="model.typeOfHeatPump" id="name" :value="model.name" type="govInputText" label="Name"
