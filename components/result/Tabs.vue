...
<template>
	...
	<template v-if="result?.resultType === 'ok'">
		<GovWarningText>
			This is an indicative compliance report based on version FHS 1.0.0-alpha7 of the Home Energy Model. This is not the same model that will be used for future homes standard and shouldn't be used for compliance.
		</GovWarningText>
