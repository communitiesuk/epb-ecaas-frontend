...
const help = 'Enter the tilt angle of the external surface. 0° means the external surface is facing up like ceilings, and 180° means the external surface is facing down like floors.';
...
<template>
	...
	<FormKit
		v-else :id="id ?? 'pitch'" type="govInputWithSuffix" :label="label ?? 'Pitch'" :help=help :name="name ?? 'pitch'"
