...
<template>
	...
	>
		<GovDetails summary-text="Help with this input">
			...
			<table v-if="showFloorGuidance" class="govuk-table floor-areal-heat-capacity-table" data-testid="floorArealHeatCapacityTable">
				...
				<tbody class="govuk-table__body">
					<tr class="govuk-table__row">
						...
						<td class="govuk-table__cell">All timber floors (suspended and exposed)
...
:deep(.floor-areal-heat-capacity-table th:nth-child(4)),
:deep(.floor-areal-heat-capacity-table td:nth-child(4)) {
    width: 18%;
}
</style>