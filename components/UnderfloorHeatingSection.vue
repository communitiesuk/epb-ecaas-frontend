...
<template>
	...
	<FormKit
		id="selectUnderFloorHeating" type="govPcdbProduct" label="Select product" name="productReference"
	...
	<FormKit
		id="areaOfUnderfloorHeating" name="areaOfUnderfloorHeating" type="govInputWithSuffix"
		label="Area of underfloor heating" suffix-text="m²" validation="required" />
</template>
