		...
		[defaultZoneName]: {
			BuildingElement: {
				...
				"Suspended Floor (floor)": {
					...
					height_upper_surface: 0.1,
					area_per_perimeter_vent: 0.0001,
					thermal_resist_insul: 1,
					thermal_transm_walls: 1,
			...
			SpaceHeatSystem: ["Warm Air Heater 1", "Wet distribution system"],
			ThermalBridging: {},
			volume: 300,
			livingroom_area: 50,
...
const expectedFlatInput: FhsInputSchema = {
	...
	Zone: {
		[defaultZoneName]: {
			...
			SpaceHeatSystem: ["Warm Air Heater 1", "UFH System"],
			ThermalBridging: {
